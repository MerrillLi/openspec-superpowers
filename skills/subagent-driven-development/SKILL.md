...
```dot
digraph when_to_use {
    "Have implementation plan (OpenSpec change tasks)?" [shape=diamond];
    "Tasks mostly independent?" [shape=diamond];
    "Stay in this session?" [shape=diamond];
    "subagent-driven-development" [shape=box];
    "Manual execution or explore/propose first" [shape=box];

    "Have implementation plan (OpenSpec change tasks)?" -> "Tasks mostly independent?" [label="yes"];
    "Have implementation plan (OpenSpec change tasks)?" -> "Manual execution or explore/propose first" [label="no"];
    "Tasks mostly independent?" -> "Stay in this session?" [label="yes"];
    "Tasks mostly independent?" -> "Manual execution or explore/propose first" [label="no - tightly coupled"];
    "Stay in this session?" -> "subagent-driven-development" [label="yes"];
    "Stay in this session?" -> "Manual execution or explore/propose first" [label="no - other session"];
}
```
...
[Read plan once: openspec/changes/<change>/tasks.md and related artifacts]
